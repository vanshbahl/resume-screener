...
from parser_tests.framework.evaluate_resume import load_expected_output, evaluate_single_resume
from parser_tests.framework.evaluate_jd import evaluate_single_jd, load_expected_jd_output
