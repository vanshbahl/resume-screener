...
from app.schemas.intelligence import MatchResult, Explanation, FeatureVector

class RankingAdapter:
    """Bridges search results with the existing ScoringService."""
    
    def rank_results(self, context: SearchContext, filtered_ids: Set[str]) -> List[Dict[str, Any]]:
        ...
        req_vec = FeatureVector(
            ...
            years_experience=context.query.experience.min if context.query.experience else 0.0
        )
