...
from parser_tests.generator.metadata.ground_truth import generate_expected_json, generate_metadata_json, generate_notes_md
from parser_tests.generator.data.pools import EXPERIENCE_LEVELS
...
def generate_resume_bundle(builder: ResumeProfileBuilder, output_dir: str, index: int, **kwargs):
    ...
    main_resumes = os.path.abspath(os.path.join(output_dir, "../../datasets/sample_resumes"))
    main_expected = os.path.abspath(os.path.join(output_dir, "../../datasets/expected_outputs"))
