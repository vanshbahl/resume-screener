...
try:
    ...
    print("Warning: Failed to load spaCy model. Ensure 'python -m spacy download en_core_web_sm' was run.")
    nlp = None
...
SKILLS_FILE = os.path.join(os.path.dirname(__file__), "..", "core", "skills_dictionary.json")
