...
from app.decision.services.recommendations import \
    learning_recommender as recommendation_service
...
from app.schemas.intelligence import (CandidateProfile, GapAnalysis, Insight,
                                      JobProfile, RankingResult,
